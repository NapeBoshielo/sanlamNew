...
namespace ILR_TestSuite.New_Business.Sales_App
{
...

    {
      ...
      //  string main1_="";
        ...
        public void PositiveTestProcess()
        {
            ...
            //Building
            Delay(1);
            _driver.FindElement(By.XPath("/html/body/div[1]/div[1]/article/section/form/div[1]/div/div[1]/input")).SendKeys("27 Beacon Avenue");
            //Street
            Delay(1);
